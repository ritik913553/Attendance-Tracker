...
function AccountDetails() {
  ...
  return (
    <div className=" w-full h-full flex flex-col sm:items-center px-3 sm:px-0 text-white ">
      ...
      <div className="sm:w-[45%] sm:mt-8">
        <div
          className="w-full flex flex-col sm:mt-0 mt-20  px-2 sm:px-4">
          <h1 className="text-4xl font-semibold mb-1 text-white">Sign Up</h1>
        ...
        <div className="px-1 py-2  rounded mt-3">
          ...
          {/* Google Sign In */}
          <span className="inline-block w-full mt-5 sm:mt-5">
