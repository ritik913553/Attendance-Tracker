...
function AccountDetails() {
  ...
  const onSubmit = (data) => {
    alert("Now Verify the email address");
    reset();
  };
  ...
  return (
    <div className="w-full h-full flex flex-col sm:items-center px-3 sm:px-0 text-white">
      <div className="w-full flex flex-col sm:items-center mt-20 sm:mt-1">
        <h1 className="text-4xl font-semibold mb-1 text-white sm:mr-[320px]">Sign Up</h1>
        <div className="flex items-center text-zinc-400 sm:mr-[241px]">
          <p className="text-sm">Already have an account?</p>
          <Link onClick={() => navigate(-1)} className="text-sm ml-2 text-blue-600">Sign in</Link>
        </div>
      </div>

      <div className="px-1 py-2 sm:w-[450px]">
        <div className="bg-[#121212] p-6 shadow-lg w-full min-h-[90px] flex flex-col justify-center mt-5 sm:mt-1 mb-5">
        ...
        <div className="divider text-white flex items-center justify-center py-1 mt-1 mb-1">
